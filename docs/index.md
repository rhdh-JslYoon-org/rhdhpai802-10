...
The source code for your chosen application can be found in [https://github.com/rhdh-JslYoon-org/rhdhpai802-10](https://github.com/rhdh-JslYoon-org/rhdhpai802-10).

The GitOps repository, which contains the Kubernetes manifests for the application can be found in 
[https://github.com/rhdh-JslYoon-org/rhdhpai802-10-gitops](https://github.com/rhdh-JslYoon-org/rhdhpai802-10-gitops). 

# Deployment Information

You can find deployed resources from this template in the **rhdhpai802-10** namespace.
